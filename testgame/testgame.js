  ...
  {id: 5,
    directions: [
      {dir: "n", img: "5n.png", interactions: []},
        ...
        {id: "30938", type: "check", img: "cube.png", x: 200, y: 173, width: 30, height: 30, effect: function(){int.checkItem("i006", function(){int.displayMessage("Nice cube, bro!")}, function(){int.displayMessage("You are not carrying any cubes.")})} },
      ]},
